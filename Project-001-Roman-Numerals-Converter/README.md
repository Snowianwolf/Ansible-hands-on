# Project-001 : Roman Numerals Converter Application (Python Flask) deployed on Red Hat using Ansible

## Description

The Roman Numerals Converter Application aims to convert the given number to the Roman numerals. The application is to be coded in Python and deployed as a web application with Flask on Rad Hat Instance using Ansible.
